    ...
    def __init__(self, image_path, density_path):
        ...
        for image_format in IMAGE_FORMAT:
            ...
            for image_path in exists_images:
                ...
                density_path = density_path if os.path.exists(density_path) else ''
                self.file_path_list.append((image_path, density_path))
...
if __name__ == '__main__':
    ...
    density_path = "/Users/Biomind/Documents/周文静/TasselNet/spruce/202011_den/train"
    size = (224, 224)
    date_reader = DatasetReader(image_path, density_path)
